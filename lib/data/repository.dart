...
import 'package:redesprou_boilerplate_name/models/post/post.dart';
import 'package:redesprou_boilerplate_name/models/post/post_list.dart';
...
class Repository {
  ...
  Future<List<Post>> findPostById(int id) {
    ...
    //making db call
    return _postDataSource.getAllSortedByFilter(filters: filters).then((posts) => posts).catchError((error) => throw error);
  }
